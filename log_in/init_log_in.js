var sTransferNumber;
        ...
        window.onload = function () {
            ...
            // Expert mode settings hardcoded
            ...
            window.localStorage.setItem('org.doubango.expert.websocket_server_url', "wss://192.168.8.15:8089/ws");
            window.localStorage.setItem('org.doubango.expert.sip_outboundproxy_url', "");
            window.localStorage.setItem('org.doubango.expert.ice_servers', "[{ url: 'stun:stun.I.google.com:19302'}]");
        ...
        function saveCredentials() {
            if (window.localStorage) {
                window.localStorage.setItem('org.doubango.identity.display_name', txtPrivateIdentity.value);
                window.localStorage.setItem('org.doubango.identity.impi', txtPrivateIdentity.value);
                window.localStorage.setItem('org.doubango.identity.impu', "sip:" + txtPrivateIdentity.value + "@" + "192.168.8.15");
                window.localStorage.setItem('org.doubango.identity.password', txtPassword.value);
                window.localStorage.setItem('org.doubango.identity.realm', "192.168.8.15");
            }
        };
        ...
        function sipRegister() {
            ...
            try {
                ...
                oSipStack = new SIPml.Stack({
                    ...
                    impu: "sip:" + txtPrivateIdentity.value + "@" + "192.168.8.15",
